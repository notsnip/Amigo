...
def Introduction():
    ...
    try:
        driver.find_element(by=By.XPATH,value="/html/body/div/main/div/div/div[1]/div[4]/div/div[2]/div/div/textarea").send_keys("Hello, your official name from now on is amigo. Don't mention its your nickname and my name is snipc. Dont scream haha. and dont reply to this message. reply to things i say below this. keep your humour down but always be serious when i am asking some info.")
